// Static data: Official DOB Complaint Category codes — source:
// nyc.gov/assets/buildings/pdf/complaint_category.pdf (Rev. 09/21).
// Moved verbatim from generate-dd-report/index.ts. Do not edit values.
