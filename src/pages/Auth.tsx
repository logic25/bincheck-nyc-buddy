      ...
      <main className="flex-1 flex items-center justify-center px-4">
        <Card className="w-full max-w-md border-border bg-card">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              {isLogin
                ? "Sign in to access your DD reports and saved searches"
                : "Enter your invite code to create an account"}
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            {/* OAuth buttons - available on both sign-in and sign-up */}
            <Button
              type="button"
              variant="outline"
              className="w-full"
            ...
            <div className="relative my-2">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-card px-2 text-muted-foreground">or {isLogin ? "sign in" : "sign up"} with email</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {!isLogin && (
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">Beta access requires an invite code</p>
                </div>
              )}
            ...
            <div className="text-center">
              <button
                onClick={() => { setIsLogin(!isLogin); setInviteCode(''); }}
                className="text-sm text-muted-foreground hover:text-foreground transition-colors"
              >
